...
export const Blogcard = ({
  ...
  return (
    <Link to={`/blog/${id}`}>
      <div className="border-b  border-slate-200 pb-4 p-4 max-w-screen-md cursor-pointer ">
        <div className="flex">
        ...
        <div className="text-md font-normal pl-2">
          {content.slice(0, 200) + "...."}
        </div>
        <div className="text-sm text-slate-400 pt-1 pl-2">
...
export function Circle() {
  return <div className="rounded-full h-1 w-1 bg-slate-500 mt-1"></div>;
}
